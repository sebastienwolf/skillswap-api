...
class ExchangeableFilters
{
    ...
    public static function fromRequest(Request $request): self
    {
        ...
        return new self(
            ...
            // Guard explicite plutôt que le guard par défaut : ces routes de
            // listing sont publiques (pas de middleware `auth:sanctum`), donc
            // le guard par défaut (`web`, session) ne verrait jamais le token
            // Bearer envoyé par le frontend et `user()` renverrait toujours
            // null, même pour un utilisateur connecté.
